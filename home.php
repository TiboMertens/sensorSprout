                    ...
                    <div>
                        <div class="w-[372px] md:w-[452px] lg:w-[522px] h-[520px] rounded-lg bg-[#739B72] flex flex-col justify-between border-[8px] border-dashed" style="border-color: <?php echo $border ?>;">
                            ...
                            <div class="flex flex-col items-center">
                                <a class="h-[48px] text-center bg-[#81CCDE] mt-[20px] w-[270px] md:w-[370px] lg:w-[458px] rounded-[5px] hover:bg-[#5EBCD4] font-bold text-[18px] text-white tracking-[2px] pt-[10px]" href="dashboard.php?id=<?php echo $moestuin_id ?>&sensorID=<?php echo $sensor_id ?>">DASHBOARD</a>
